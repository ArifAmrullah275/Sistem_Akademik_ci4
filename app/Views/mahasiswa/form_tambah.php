...
<div class="container-fluid px-4 pb-5">
    <div class="card mt-3 card-modern">
        ...
        <div class="card-body p-4">
            <form class="row g-3" action="<?= base_url('mahasiswa/simpan') ?>" method="post">
                <?= csrf_field(); ?>

                <div class="col-md-6">
                    <label class="form-label">NPM</label>
                    <input type="text" name="nim" class="form-control <?= ($validation->hasError('nim')) ? 'is-invalid' : ''; ?>" value="<?= old('nim') ?>" placeholder="Masukkan NPM" autofocus required>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="nama" class="form-control <?= ($validation->hasError('nama')) ? 'is-invalid' : '' ?>" value="<?= old('nama') ?>" placeholder="Masukkan Nama Lengkap" required>
                    <div class="invalid-feedback">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="alamat" class="form-control" value="<?= old('alamat') ?>" placeholder="Alamat Domisili" required>
                </div>
            ...
            if (typeof Swal !== 'undefined') {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.open('https://wa.me/6283827914570?text=Halo%20Admin,%20saya%20butuh%20bantuan%20terkait%20Tambah%20Data%20Mahasiswa.', '_blank');
                    }
                });
            } else {
